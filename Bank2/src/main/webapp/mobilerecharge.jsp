...
<%@ page import="controller.mobilerecharge"%>
...
<div class="main">
    <div class="navbar">
        <div class="icon">
            <h2 class="logo">Recharge Heaven&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h2>
        </div>
...
<div class="footer">
    <div class="footer-content">
        <div class="footer-section about">
            <h3>About Recharge Heaven</h3>
            <p>Recharge Heaven is a leading online platform for mobile recharge and bill payments. We provide a seamless recharge experience with secure transactions and a wide range of service providers. Recharge your mobile phone, DTH, or data card hassle-free with Recharge Heaven.</p>
        </div>
    ...
    <div class="footer-bottom">
        &copy; 2023 Recharge Heaven. All rights reserved.
    </div>
</div>
